        ...
        <div class="contact">
          ...
          <div class="content">
            <div class="item-wrap">
              ...
              <span class="text-wrap">18862142956</span>
            </div>
            <div class="item-wrap">
              <img src="../images/email.png">
              <span class="text">公司邮箱</span>:
              <span class="text-wrap">875889022@qq.com</span>
            </div>
            <div class="item-wrap">
              <img src="../images/fax.png">
              <span class="text">传真</span>:
              <span class="text-wrap">010-52486932</span>
            </div>
            <div class="item-wrap">
              <img src="../images/location.png">
              <span class="text">公司地址</span>:
              <span class="text-wrap">工业园区独墅湖启月街1号</span>
            </div>
          </div>
        </div>
        <div class="news">
         <div class="news-title">
          ...
          <div class="content">
            <div class="item-wrap" v-for="(item, index) in 4" :key="index">
              ...
              <div class="news-text">
                <span class="ext">公告主标题内容公告主标题内容</span>
